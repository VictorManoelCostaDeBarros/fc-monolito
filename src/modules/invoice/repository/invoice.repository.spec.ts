...
describe("InvoiceRepository test", () => {
  ...
  it("should create a new invoice", async () => {
    ...
    expect(result.items[0].dataValues.id).toBe(invoice.items[0].id.id);
    expect(result.items[0].dataValues.name).toBe(invoice.items[0].name);
    expect(result.items[0].dataValues.price).toBe(invoice.items[0].price);
    expect(result.items[1].dataValues.id).toBe(invoice.items[1].id.id);
    expect(result.items[1].dataValues.name).toBe(invoice.items[1].name);
    expect(result.items[1].dataValues.price).toBe(invoice.items[1].price);
